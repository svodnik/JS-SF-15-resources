...
// Add a Remove button to each item in the survey, including those that are present when the DOM first loads
$("#surveyList li").each(function () {
  const $removeButton = $('<button>').attr('type', 'button').text("Remove question");
